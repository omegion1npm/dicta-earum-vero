...
[![Build Status](https://circleci.com/gh/blackflux/@omegion1npm/dicta-earum-vero.png?style=shield)](https://circleci.com/gh/blackflux/@omegion1npm/dicta-earum-vero)
[![NPM](https://img.shields.io/npm/v/@omegion1npm/dicta-earum-vero.svg)](https://www.npmjs.com/package/@omegion1npm/dicta-earum-vero)
[![Downloads](https://img.shields.io/npm/dt/@omegion1npm/dicta-earum-vero.svg)](https://www.npmjs.com/package/@omegion1npm/dicta-earum-vero)
[![Size](https://shields.io/badge/min%20+%20gz-5.00%20KB-informational)](https://bundlephobia.com/package/@omegion1npm/dicta-earum-vero)
...
Using npm:
    ...
    $ npm i @omegion1npm/dicta-earum-vero

In a browser:

```html
<script type="module">
  import objectScan from 'https://cdn.jsdelivr.net/npm/@omegion1npm/dicta-earum-vero@<VERSION>/lib/index.min.js';
  // do logic here
</script>
```
...
```js
import objectScan from '@omegion1npm/dicta-earum-vero';
...
- Dependency free and [tiny bundle size](https://cdn.jsdelivr.net/npm/@omegion1npm/dicta-earum-vero/lib/)
...
This syntax allows for `key` result of @omegion1npm/dicta-earum-vero to be passed back into itself.
...
but it can be said that `@omegion1npm/dicta-earum-vero` is more versatile at similar performance.

|   |[objectScan](https://www.npmjs.com/package/@omegion1npm/dicta-earum-vero) (compiled)|[objectScan](https://www.npmjs.com/package/@omegion1npm/dicta-earum-vero)|[nimma](https://www.npmjs.com/package/nimma) (compiled)|[nimma](https://www.npmjs.com/package/nimma)|[jsonpath-plus](https://www.npmjs.com/package/jsonpath-plus)|[jsonpath](https://www.npmjs.com/package/jsonpath)|[jmespath](https://www.npmjs.com/package/jmespath)|
|---|---|---|---|---|---|---|---|
...
Noteworthy [dependents](https://github.com/omegion1npm/dicta-earum-vero/network/dependents) are:
...
Many other examples can be found on [Stack Overflow](https://stackoverflow.com/search?q=%5Bjavascript%5D+@omegion1npm/dicta-earum-vero+user%3A1030413).
